...
public class IntakeAndShootFromDepot extends Auto {
    ...
    try {
        ...
        addCommands(
            ...
            shootFromDepot.andThen(() -> swerveDrive.setControl(stopRequest)).andThen(new PrintCommand("[AUTO] Ready to shoot from depot")),
            ...
            ).withTimeout(4).andThen(new PrintCommand("[AUTO] Finished shooting from depot")) // TODO: Also auto-detect when we're done shooting
        );
      } catch (Exception e) {
