...
public class AutoAlignDrive extends Command {
  ...
  public AutoAlignDrive(
      SwerveSubsystem commandSwerveDrivetrain,
      Vision vision,
  ...
  @Override
  public void execute() {
    var setPoint = m_goal.minus(m_swerveDrivetrain.getState().Pose.getTranslation()).getAngle();
    m_swerveDrivetrain.setChassisSpeedsWithHeading(
        SWERVE.kMaxSpeed.times(m_throttleInput.getAsDouble()),
        SWERVE.kMaxSpeed.times(m_turnInput.getAsDouble()),
        setPoint);
  }
