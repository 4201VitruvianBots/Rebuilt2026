...
public class Shoot extends Command {
  ...
  static {
    ...
    distanceToShotMap.put(Meters.of(1.391736631), new Shot(RPM.of(1470), Degrees.of(1.0), 0.9)); //
    distanceToShotMap.put(
        Meters.of(1.45650895207174), new Shot(RPM.of(1470), Degrees.of(2.0), 1.0)); // Tuned
    distanceToShotMap.put(
        Meters.of(1.9791021529687), new Shot(RPM.of(1530), Degrees.of(3.0), 1.09)); // Tuned
    distanceToShotMap.put(
    ...
    distanceToShotMap.put(
        Meters.of(3.404527735240185), new Shot(RPM.of(1780), Degrees.of(10), 1.115)); // Half Tuned
    ...
    distanceToShotMap.put(Meters.of(4.6722084908365), new Shot(RPM.of(2000), Degrees.of(13), 1.12));
    distanceToShotMap.put(
