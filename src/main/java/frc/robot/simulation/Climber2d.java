...
public class Climber2d {
  private Color8Bit bottomClimberColor =
      new Color8Bit(219, 0, 255); // Blue-ish magenta color for bottom climber
  ...
  public void update(Distance height, LinearVelocity velocity) {
    ...
    // When the top carriage starts at the bottom, the top hook stays at -180 degrees. It slowly
    // moves to -90 degrees as it goes up, reaching -90 degrees at 1.25 inches.
    double topHookAngle = -180.0;
    // When the bottom carriage starts at the top, the bottom hook stays at -180 degrees. It slowly
    // moves to -135 degrees as it goes down, reaching -135 degrees at 1.25 inches below max height.
