...
public class Hood extends SubsystemBase {
  ...
  private final TalonFX m_motor =
      new TalonFX(CAN.kShooterHoodMotor, CAN.driveBaseCanbus); // Replace these device ids after motors are set up

  private final CANcoder m_cancoder =
      new CANcoder(CAN.kShooterHoodCANCoder, CAN.driveBaseCanbus); // Replace these device ids after motors are set up
