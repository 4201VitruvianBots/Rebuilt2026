...
public class TestVision {
  ...
  public void test_isOnTarget() {
    ...
    // Set the Robot's Rotation. m_cachedState is an inherited value from CTRE's class that contains
    // the values we want from swerveDrive.getState()
    //        TestUtils.setPrivateField(swerveDrive, "m_cachedState", new SwerveDriveState());
    SwerveDriveState swerveDriveState =
        (SwerveDriveState) TestUtils.getPrivateObject(swerveDrive, "m_cachedState");
